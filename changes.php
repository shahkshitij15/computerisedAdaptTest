...
<body>
   <div class="container">
         ...
         <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
               <ul class="nav navbar-nav navbar-right">
                  <li>
                     <a href ="student.php"class="navbar-brand"><span class="glyhicon glyphicon-user"></span><?php echo $_SESSION['username'] ?></a>
                  </li>
      ...
      <br><br><br><br>
      <form class="form-horizontal" action="changes.php" method="post">
         ...
         if (isset($_POST['old'], $_POST['new'], $_POST['cnf_new']))
            $res = $user->change_pwd_s($uid, $_POST['old'], $_POST['new'], $_POST['cnf_new']);
            //if($res)
