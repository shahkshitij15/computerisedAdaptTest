...
<body>
    ...
    <div class="container-fluid" style="padding: 80px;">
            ...
            <div class="card-footer text-left">
                ...
                <form action="exam.php" method="post">
                    ...
                    if (isset($_POST['exampleRadios'])) {
                            $answer = $user->check_answer($_SESSION['subject'],$_POST['exampleRadios'],$row['answer']);                         if ($answer)
                                echo "TRUE";
                            else
                                echo "FALSE";
                        }
        ...
        <?php
                    if (isset($_POST['exampleRadios'])) {
                            $answer = $user->check_answer($_SESSION['subject'],$_POST['exampleRadios'],$row['answer']);
                            if ($answer)
                                echo "TRUE";
                            else
                                echo "FALSE";
