...
$result = $user->get_question($_SESSION['diff']);
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        if(isset($_GET['submit']))
        {
            if($_GET['submit']=='skip')
            {
                ...
                $r=$user->submit_answer($_SESSION['count'],$_SESSION['qid'],'');
                ...
                if(isset($_GET['answer']))
                {
                    ...
                    $r=$user->submit_answer($_SESSION['count'],$_SESSION['qid'],$_GET['answer']);
                    $_SESSION['count']++;

                    
                   
                    $ans=$user->check_answer($_SESSION['qid'],$_GET['answer']);
